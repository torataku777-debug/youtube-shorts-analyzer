...
declare const PagesTopLoader: {
    ({ color: propColor, height: propHeight, showSpinner, crawl, crawlSpeed, initialPosition, easing, speed, shadow, template, zIndex, showAtBottom, nonce, }: NextTopLoaderProps): JSX.Element;
    propTypes: {
